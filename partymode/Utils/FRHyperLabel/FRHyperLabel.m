...
+ (void)initialize {
	if (self == [FRHyperLabel class]) {
		FRHyperLabelLinkColorDefault = [UIColor colorWithRed:0/255.0 green:209/255.0 blue:214/255.0 alpha:1];
		FRHyperLabelLinkColorHighlight = [UIColor colorWithRed:28/255.0 green:135/255.0 blue:199/255.0 alpha:1];
	}
}
